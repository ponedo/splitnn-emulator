...
type NetlinkPassthroughLookupNetworkManager struct {
	name2handle map[string]netns.NsHandle
}

func (ntlm *NetlinkPassthroughLookupNetworkManager) Init() error {
	ntlm.name2handle = make(map[string]netns.NsHandle)
	return nil
}

func (ntlm *NetlinkPassthroughLookupNetworkManager) Delete() error {
	return nil
}

func (ntlm *NetlinkPassthroughLookupNetworkManager) SetupNode(nodeId int) error {
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) DestroyNode(nodeId int) error {
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) SetupLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) DestroyLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) SetupInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) DestroyInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) SetupExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	var hostNetns, nodeiNetNs netns.NsHandle
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) DestroyExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	// var hostNetns, nodeiNetNs netns.NsHandle
...
func (ntlm *NetlinkPassthroughLookupNetworkManager) getNsHandle(nsName string) (netns.NsHandle, error) {
	var err error
