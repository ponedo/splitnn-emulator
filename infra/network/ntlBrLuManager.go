...
type NetlinkBridgeLookupNetworkManager struct {
	name2handle map[string]netns.NsHandle
}

func (ntlm *NetlinkBridgeLookupNetworkManager) Init() error {
...
func (ntlm *NetlinkBridgeLookupNetworkManager) Delete() error {
	SetupNodeCommand := exec.Command(
...
func (ntlm *NetlinkBridgeLookupNetworkManager) SetupNode(nodeId int) error {
	SetupNodeCommand := exec.Command(
...
func (ntlm *NetlinkBridgeLookupNetworkManager) DestroyNode(nodeId int) error {
...
func (ntlm *NetlinkBridgeLookupNetworkManager) SetupLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkBridgeLookupNetworkManager) DestroyLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkBridgeLookupNetworkManager) SetupInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeLookupNetworkManager) DestroyInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeLookupNetworkManager) SetupExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeLookupNetworkManager) DestroyExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	var hostNetns, backboneNs netns.NsHandle
	var brName string
...
func (ntlm *NetlinkBridgeLookupNetworkManager) getNsHandle(nsName string) (netns.NsHandle, error) {
	var err error
