...
type NetlinkPassthroughNsCacheNetworkManager struct {
	name2handle map[string]netns.NsHandle
}

func (ntlm *NetlinkPassthroughNsCacheNetworkManager) SetupBackboneNetns() error {
	return nil
}

func (ntlm *NetlinkPassthroughNsCacheNetworkManager) DestroyBackboneNetns() error {
	return nil
}

func (ntlm *NetlinkPassthroughNsCacheNetworkManager) Init() error {
	ntlm.name2handle = make(map[string]netns.NsHandle)
	return nil
}

func (ntlm *NetlinkPassthroughNsCacheNetworkManager) Delete() error {
	return nil
}

func (ntlm *NetlinkPassthroughNsCacheNetworkManager) SetupNode(nodeId int) error {
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) DestroyNode(nodeId int) error {
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) SetupLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) DestroyLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	if vxlanID == -1 {
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) SetupInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) DestroyInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) SetupExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	var hostNetns, nodeiNetNs netns.NsHandle
...
func (ntlm *NetlinkPassthroughNsCacheNetworkManager) DestroyExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	var hostNetns, nodeiNetNs netns.NsHandle
...
// func (ntlm *NetlinkPassthroughNsCacheNetworkManager) getNsHandle(nsName string) (netns.NsHandle, error) {
// 	var err error
