...
type NetlinkBridgeNsCacheNetworkManager struct {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) SetupBackboneNetns() error {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) DestroyBackboneNetns() error {
	SetupNodeCommand := exec.Command(
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) Init() error {
	ntlm.name2handle = make(map[string]netns.NsHandle)
	return nil
}

func (ntlm *NetlinkBridgeNsCacheNetworkManager) Delete() error {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) SetupNode(nodeId int) error {
	SetupNodeCommand := exec.Command(
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) DestroyNode(nodeId int) error {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) SetupLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	startTime := time.Now()
	if vxlanID == -1 {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) DestroyLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	startTime := time.Now()
	if vxlanID == -1 {
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) SetupInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) DestroyInternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) SetupExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
...
func (ntlm *NetlinkBridgeNsCacheNetworkManager) DestroyExternalLink(nodeIdi int, nodeIdj int, serverID int, vxlanID int) error {
	var err error
	var hostNetns, backboneNs netns.NsHandle
	var brName string
	var startTime time.Time
