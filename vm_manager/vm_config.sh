...
RAW_VIRTIO_IP_PREFIX="10.100.${HOST_ID}." # The subnet for the VMs
SUBNET_MASK="16" # The subnet mask length for the VMs
HOST_ID_HEXA=$(printf "%x" $HOST_ID)
RAW_MAC_PREFIX="52:54:00:ab:${HOST_ID_HEXA}:" # The MAC address prefix for the VMs
